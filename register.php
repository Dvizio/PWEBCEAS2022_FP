...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = mysqli_real_escape_string($conn, 'Belum Mendaftar');
        ...
        if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    //     $mail->Username   = 'zufarrifqi46@gmail.com';                     //SMTP username
                    //     $mail->Password   = 'ioqaqgmiqpyzdjnq';                               //SMTP password
                    //     $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                    //     $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                    //     //Recipients
                    //     $mail->setFrom('zufarrifqi46@gmail.com');
                    //     $mail->addAddress($email);

                    //     //Content
                    //     $mail->isHTML(true);                                  //Set email format to HTML
                    //     $mail->Subject = 'no reply';
                    //     $mail->Body    = 'Here is the verification link <b><a href="http://localhost/fpnyoba/?verification='.$code.'">http://localhost/fpnyoba/?verification='.$code.'</a></b>';
